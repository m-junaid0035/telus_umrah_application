...
export default async function PackageBookingViewPage({
  ...
  const booking: PackageBooking = {
    ...
    travelers: {
      ...
      childAges: Array.isArray(bookingData.travelers?.childAges) ? bookingData.travelers.childAges.map(Number) : undefined,
    },
      ...
      <div className="space-y-6">
        ...
        <div className="border-b pb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">Package ID</p>
              <p className="text-gray-900 dark:text-gray-100">{booking.packageId}</p>
            </div>
          </div>
        </div>
        ...
        <div className="border-b pb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <p className="text-gray-900 dark:text-gray-100">{booking.travelers.adults}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500 dark:text-gray-400">Children</p>
              <p className="text-gray-900 dark:text-gray-100">{booking.travelers.children}</p>
            </div>
            <div>

    ...
    const loadHotels = async () => {
      ...
      try {
        ...
        if (result?.data && Array.isArray(result.data)) {
          // Filter only Madina hotels
          const madinaHotels = result.data.filter((h: any) => h.type === 'Madina') as BackendHotel[];
          setHotels(madinaHotels);
        } else {
          toast({
            title: "Error",
          ...
          {loading ? (
            ...
            filteredHotels.map((hotel, index) => {
              ...
              return (
                ...
                >
                  <Link href={`/madina-hotels/madinah/${slug}`}>
